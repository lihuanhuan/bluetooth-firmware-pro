...
void usr_rtc_tick_disable(void) { nrf_drv_rtc_tick_disable(&s_rtc_handle); }

void rtc_set_time(uint32_t timestampNow) { m_timestamp = timestampNow; }

uint32_t rtc_get_time(void) { return m_timestamp; }
